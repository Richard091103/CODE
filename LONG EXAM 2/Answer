...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String strand = scan.next().toUpperCase();
        ...
        if (studentEmailAddress.contains("meneses") && studentEmailAddress.contains("@student.national-u.edu.ph")) {
            System.out.println("VALID");
        } else {
            System.out.println("INVALID");
        }
    ...
    static void num3() {
        ...
        System.out.println("Sum of character length of my first name and surname is: " + (Stringsize1 + Stringsize2));
    }
    ...
    static void num4() {
        ...
        if (firstNumber >= secondNumber && firstNumber >= thirdNumber) {
            ...
            System.out.println(thirdNumber + " is the largerst number");
